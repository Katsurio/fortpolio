        ...
        <div class="row">
            <div class="col-md-6 pull-left">
                ...
                <div class="mt-lg">
                    ...
                    <a href="https://www.fridge2plate.com" class="btn btn-tertiary text-capitalize text-color-primary custom-btn-style-1 custom-margin-2 text-sm" target="_blank"><i class="fa fa-github-alt"></i>&nbsp; View Code</a>
                </div>
            </div>
