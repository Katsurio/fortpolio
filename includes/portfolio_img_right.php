    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 mt-lg">
                <img class="img-responsive appear-animation" src="img/demos/resume/portfolio/device.png" data-appear-animation="fadeInRight" alt="">
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-6 mt-lg">
                <img class="img-responsive appear-animation" src="img/demos/resume/portfolio/device.png" data-appear-animation="fadeInLeft" alt="">
            </div>
            <div class="col-md-6">
                <h2 class="mt-lg">Premium <strong>Features</strong></h2>
                <p class="lead">
