<section id="about-me" class="section section-no-border section-parallax custom-section-padding-1 custom-position-1 custom-xs-bg-size-cover m-none" data-plugin-parallax data-plugin-options="{'speed': 1.5}" data-image-src="img/demos/resume/about-me/about-me-bg.jpg">
    <div class="container">
        <div class="row">
    ...
    <ul class="social-icons custom-social-icons">
        <li class="social-icons-github">
            <a href="https://www.github.com/katsurio/" target="_blank" title="Github">
                <i class="fa fa-github"></i>
            </a>
        </li>
        <li class="social-icons-linkedin">
            <a href="https://www.linkedin.com/in/john-e-fisher/" target="_blank" title="Linkedin">
                <i class="fa fa-linkedin"></i>
            </a>
        </li>
        <li class="social-icons-angellist">
            <a href="https://angel.co/katsurio/" target="_blank" title="AngelList">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-2 col-sm-4 center custom-xs-border-bottom p-none">
                <a href="mailto:jfisher.jobs@gmail.com" class="text-decoration-none">
